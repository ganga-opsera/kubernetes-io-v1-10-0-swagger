...
func Replacerbacauthorizationv1namespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapirbacv1RoleBinding
		...
		var result models.Iok8sapirbacv1RoleBinding
...
func CreateReplacerbacauthorizationv1namespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_rbac_authorization_k8s_io_v1_namespaces_namespace_rolebindings_name",

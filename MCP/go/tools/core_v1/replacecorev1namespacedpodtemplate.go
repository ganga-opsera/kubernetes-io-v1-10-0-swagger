...
func Replacecorev1namespacedpodtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicorev1PodTemplate
		...
		var result models.Iok8sapicorev1PodTemplate
...
func CreateReplacecorev1namespacedpodtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_namespaces_namespace_podtemplates_name",
		...
		mcp.WithObject("template", mcp.Description("Input parameter: PodTemplateSpec describes the data a pod should have when created from a template")),
	)

...
func Replacerbacauthorizationv1alpha1clusterrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapirbacv1alpha1ClusterRoleBinding
		...
		var result models.Iok8sapirbacv1alpha1ClusterRoleBinding
...
func CreateReplacerbacauthorizationv1alpha1clusterrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_rbac_authorization_k8s_io_v1alpha1_clusterrolebindings_name",

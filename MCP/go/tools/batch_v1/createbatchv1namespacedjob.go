...
func Createbatchv1namespacedjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapibatchv1Job
		...
		var result models.Iok8sapibatchv1Job
...
func CreateCreatebatchv1namespacedjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_batch_v1_namespaces_namespace_jobs",
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: JobSpec describes how the job execution will look like.")),
		mcp.WithObject("status", mcp.Description("Input parameter: JobStatus represents the current state of a Job.")),
